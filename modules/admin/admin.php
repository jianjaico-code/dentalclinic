                ...
                <div class="col-lg-6 col-5 my-auto text-end">
                    <div class="dropdown float-lg-end pe-4">
                        ...
                        <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5"
                            ...
                            <li><a class="dropdown-item border-radius-md" onclick="init_add_employee()">Add Employee</a>
                            </li>
...
<?php include_once "./components/admin_modals.php" ?>
<script src="modules/admin/scripts/main.js"></script>
<script>

$("#srch-mat").on("keydown",function search(e) {
    if(e.keyCode == 13) {
        load_all_employee($("#srch-mat").val())
    }
});
</script>