...
<div class="card-header pb-0">
    <div class="row">
        ...
        <div class="col-7">
        <small class="text-right">#<?php echo $InvoiceNumber; ?></small>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-6">
            <div style="margin-left: 2%;" class="input-group input-group-outline w-100 mb-3">
                    <input type="number" step="any" min="0.1" id="add-amount" placeholder="Amount" class="form-control">
            </div>
        </div>
    ...
    <div style="margin-left: 2%;" class="input-group input-group-outline w-100 mb-3">
            <input type="text" step="any" min="0.1" id="add-remarks" placeholder="Remarks" class="form-control">
    </div>

    <p class="text-sm">
        <i class="fa fa-money text-success" aria-hidden="true"></i>
        <span class="font-weight-bold"><?php echo number_format((COUNT($getAllCart) > 0) ? $getAllCart[0]['FinalAmountz'] : 0, 2) ?></span> to pay
    </p>
    <p class="text-sm">
        <div class="row">
            <div class="col-8">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(!data) alert("No Inventory Found!");
                        ...
                        add_to_cart(data.MaterialID, parseFloat(data.price), qty);
                    }
                }
            });
        }
