                ...
                <div class="col-lg-6 col-5 my-auto text-end">
                    <div class="dropdown float-lg-end pe-4">
                        ...
                        <ul class="dropdown-menu px-2 py-3 ms-sm-n4 ms-n5"
                            ...
                            <li><a class="dropdown-item border-radius-md" onclick="init_add_mat()">New Material</a>
                            </li>
                            <li><a class="dropdown-item border-radius-md" onclick="init_add_gr()">Goods Receive</a></li> 

                            <li><a class="dropdown-item border-radius-md" onclick="init_conversion()">Unit Conversion</a></li>
                        </ul>
                    </div>
                </div>
