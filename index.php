...
<body class="g-sidenav-show  bg-gray-200">
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="https://github.com/jianjaico-code"
                target="_blank">
                <img src="./assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
                <span class="ms-1 font-weight-bold text-white">Lourdes Clinic Portal</span>
            </a>
        </div>
        <hr class="horizontal light mt-0 mb-2">
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <?php if($_SESSION['Patient'] != 1): ?>
                ...
                <?php else: ?>
                    <li class="nav-item">
                    <a class="nav-link text-white " onclick='$(".nav-link ").removeClass("active");$(this).addClass("active");load_med_rec();'>
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a class="font-weight-bold" target="_blank">inSource Business Solution</a>
                            </div>
                        </div>
                    </div>
                </div>
